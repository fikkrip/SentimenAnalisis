...
<section>
    ...
    <div style="font-family: Calibri;">
        ...
        <h4 align="center" style="font-family: Calibri;">LOGBOOK TINDAK LANJUT / PERBAIKAN</h4>

        <table border="1" style="border-color: white; margin-top: 20px; margin-bottom: 50px" align="center" width="100%">
            <thead>
            <tr>
                <th>NO</th>
                <th>TANGGAL</th>
            ...
            <?php
            $i=0;
            foreach($query2->sub_proyek as $row): ?>
                <tr>
